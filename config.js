module.exports = {
	...
	adminId: "890323443252351046", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "MTE0NjQ4MzUzNzM1MzEyMTg4Ng.GV1gtG.V8afAAHSPViEk8gZtgmWu2yeKyiYnDaFNFYo5M", //- Bot's Token
	clientId: process.env.clientId || "1146483537353121886", //- ID of the bot
	clientSecret: process.env.clientSecret || "RFnCx7R8QcKXmpoHt0_x46oQ7vkb_1CZ", //- Client Secret of the bot
	...
	cookieSecret: "Pixlbuilders is epic", //- Cookie Secret
	...
	nodes: [
		{
			...
			host: "lavalink-replit.darkplates.repl.co", //- The host name or IP of the lavalink server.
			port: 443, // The port that lavalink is listening to. This must be a number!
			password: "Millieiscool", //- The password of the lavalink server.
